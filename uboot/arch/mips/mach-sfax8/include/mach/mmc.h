...
#define SDIO_BASE_ADDR				(0xB7600000)
#define SIFLOWER_SDIO_OFFSET		(0x200000)
#else
#define SDIO_BASE_ADDR				(0xB7800000)
#define SIFLOWER_SDIO_OFFSET		(0x400000)
#endif
