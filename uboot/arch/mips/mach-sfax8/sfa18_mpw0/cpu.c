...
*                                                                                                 *
***************************************************************************************************/
static int set_pll_ratio(int pll_type)
{
	unsigned int i, reg, value, offset;
	unsigned long long pll_para;
...
int lowlevel_init(void)
{
	...
	//FIXME: This is a workaround for DVFS bug.
	//set cpu_clk ratio to 1:2
	writel(1, (void*)0xb9e01504);
