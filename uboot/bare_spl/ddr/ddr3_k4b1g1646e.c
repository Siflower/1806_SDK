...
#define Tck 2500
	...
	.trp = ps_to_tck(15000),
	.tras_min = ns_to_tck(37.5),
	.tras = ps_to_tck(57500),
	.twlo = ps_to_tck(9000), //EM6GD16EWKG need 7.5ns
	.twlmrd = 40,
	.tmrd = 4,
	.tmod = MAX((u32)12, ns_to_tck(15)),
	.tccd = 4,
	...
	.tcksre = MAX((u32)5, ns_to_tck(10)),
	.tcksrx = MAX((u32)5, ns_to_tck(10)),
	.trrd = MAX((u32)4, ps_to_tck(10000)), //EM6GD16EWKG only need 7.5ns
...
#define Tck 1875
	...
	.tcke = MAX((u32)3, ps_to_tck(5625)),//EM6GD16EWKG only need 3CK or 5ns
	.twtr = MAX((u32)4, ps_to_tck(7500)),
	.trtp = MAX((u32)4, ps_to_tck(7500)),
};
