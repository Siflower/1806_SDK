...
#define Tck 5000
	...
	.tfaw = ps_to_tck(37500),	// t_faw = 14
	.trc = ns_to_tck(55),      // t_rc >= 55ns
	.twr = ns_to_tck(15),		// t_wr = 4
	.trfc = ps_to_tck(127500),    // t_rfc = 0x22
	.trp = ns_to_tck(15),      // t_rp >= 15ns
	.tras_min = ns_to_tck(40),    // t_ras_min = 40ns
