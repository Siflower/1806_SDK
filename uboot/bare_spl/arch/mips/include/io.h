...
#define __raw_writeq(b, addr) (*(volatile unsigned long long *)(addr)) = (b)
...
extern void u_delay_cpu(u32 us);
extern void m_delay_cpu(u32 ms);
#define u_delay u_delay_cpu
#define m_delay m_delay_cpu
