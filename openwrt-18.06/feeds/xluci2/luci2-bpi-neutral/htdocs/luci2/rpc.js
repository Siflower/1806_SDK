Class.extend({
	...
	list: function()
	{
		...
		return this._call(msg, this._list_cb, L.globals.timeout);
	},
	...
	flush: function()
	{
		...
		/* call rpc */
		return this._call(req, this._call_cb, L.globals.timeout);
	},
	...
	declare: function(options)
	{
		...
		return function() {
			...
			/* call rpc */
			if(options.timeout !== undefined && options.timeout > L.globals.timeout)
				return _rpc._call(msg, _rpc._call_cb, options.timeout);
			else
				return _rpc._call(msg, _rpc._call_cb, L.globals.timeout);
		};
	}
});
