...
#if the target will use a small flash, then we will shutdown some features
ifeq ($(CONFIG_SIWIFI_TINY_DRIVER), y)
CONFIG_SIWIFI_TESTMODE = n
CONFIG_SIWIFI_CFGFILE = n
...
# Debug
subdir-ccflags-$(CONFIG_SIWIFI_SW_PROFILING) += -DCONFIG_SIWIFI_SW_PROFILING
