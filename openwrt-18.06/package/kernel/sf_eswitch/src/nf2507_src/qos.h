...
#ifndef __L2SW_API_QOS_H__
#define __L2SW_API_QOS_H__
...
#define L2SW_MAX_NUM_OF_PRIORITY                     8
#define L2SW_MAX_NUM_OF_QUEUE                        8

#define L2SW_PRIMAX                                             7
#define L2SW_QIDMAX                                             7
#define L2SW_DSCPMAX                                         63


/* enum Priority Selection Index */
typedef enum l2sw_qos_priDecTbl_e
{
    PRIDECTBL_IDX0 = 0,
    PRIDECTBL_IDX1,
    PRIDECTBL_END,
}l2sw_qos_priDecTbl_t;


/* Types of 802.1p remarking source */
typedef enum l2sw_qos_1pRmkSrc_e
{
...
typedef enum l2sw_qos_dscpRmkSrc_e
{
    DSCP_RMK_SRC_INT_PRI,
    DSCP_RMK_SRC_DSCP,
    DSCP_RMK_SRC_USER_PRI,
    DSCP_RMK_SRC_END
} l2sw_qos_dscpRmkSrc_t;




typedef struct l2sw_priority_select_s
{
    l2sw_uint32 port_pri;
    l2sw_uint32 dot1q_pri;
    l2sw_uint32 acl_pri;
    l2sw_uint32 dscp_pri;
    l2sw_uint32 cvlan_pri;
    l2sw_uint32 svlan_pri;
    l2sw_uint32 dmac_pri;
    l2sw_uint32 smac_pri;
} l2sw_priority_select_t;

typedef struct l2sw_qos_pri2queue_s
{
    l2sw_uint32 pri2queue[L2SW_MAX_NUM_OF_PRIORITY];
} l2sw_qos_pri2queue_t;

typedef struct l2sw_qos_queue_weights_s
{
    l2sw_uint32 weights[L2SW_MAX_NUM_OF_QUEUE];
} l2sw_qos_queue_weights_t;

typedef enum l2sw_qos_scheduling_type_e
{
    WFQ = 0,        /* Weighted-Fair-Queue */
    WRR,            /* Weighted-Round-Robin */
    SCHEDULING_TYPE_END
} l2sw_qos_scheduling_type_t;

typedef l2sw_uint32  l2sw_queue_num_t;    /* queue number*/
 ...
 */
extern l2sw_api_ret_t l2sw_qos_init(l2sw_uint8 units, l2sw_queue_num_t queueNum);
 ...
 *      - PRIDEC_SA
 */
extern l2sw_api_ret_t l2sw_qos_priSel_set(l2sw_uint8 units, l2sw_qos_priDecTbl_t index, l2sw_priority_select_t *pPriDec);
 ...
 *      - PRIDEC_SA,
 */
extern l2sw_api_ret_t l2sw_qos_priSel_get(l2sw_uint8 units, l2sw_qos_priDecTbl_t index, l2sw_priority_select_t *pPriDec);
 ...
 */
extern l2sw_api_ret_t l2sw_qos_1pPriRemap_set(l2sw_uint8 units, l2sw_pri_t dot1p_pri, l2sw_pri_t int_pri);
 ...
 */
extern l2sw_api_ret_t l2sw_qos_1pPriRemap_get(l2sw_uint8 units, l2sw_pri_t dot1p_pri, l2sw_pri_t *pInt_pri);
 ...
 */
extern l2sw_api_ret_t l2sw_qos_1pRemarkSrcSel_set(l2sw_uint8 units, l2sw_qos_1pRmkSrc_t type);
 ...
 *      None
 */
extern l2sw_api_ret_t l2sw_qos_1pRemarkSrcSel_get(l2sw_uint8 units, l2sw_qos_1pRmkSrc_t *pType);
 ...
 */
extern l2sw_api_ret_t l2sw_qos_dscpPriRemap_set(l2sw_uint8 units, l2sw_dscp_t dscp, l2sw_pri_t int_pri);
 ...
 *      DSCP are carefully chosen then backward compatibility can be achieved.
 */
extern l2sw_api_ret_t l2sw_qos_dscpPriRemap_get(l2sw_uint8 units, l2sw_dscp_t dscp, l2sw_pri_t *pInt_pri);
 ...
 */
extern l2sw_api_ret_t l2sw_qos_portPri_set(l2sw_uint8 units, l2sw_port_t port, l2sw_pri_t int_pri) ;
 ...
 */
extern l2sw_api_ret_t l2sw_qos_portPri_get(l2sw_uint8 units, l2sw_port_t port, l2sw_pri_t *pInt_pri) ;
 ...
 * Input:
 *      port    - Port id.
  *     queue_num - Mapping queue number
 * Output:
 *      None
 * Return:
 *      L2SW_ERR_OK           - OK
 ...
 */
extern l2sw_api_ret_t l2sw_qos_queueNum_set(l2sw_uint8 units, l2sw_port_t port, l2sw_queue_num_t queue_num);
 ...
 */
extern l2sw_api_ret_t l2sw_qos_queueNum_get(l2sw_uint8 units, l2sw_port_t port, l2sw_queue_num_t *pQueue_num);
 ...
 */
extern l2sw_api_ret_t l2sw_qos_priMap_set(l2sw_uint8 units, l2sw_queue_num_t queue_num, l2sw_qos_pri2queue_t *pPri2qid);
 ...
 *      The queue number is from 1 to 8.
 */
extern l2sw_api_ret_t l2sw_qos_priMap_get(l2sw_uint8 units, l2sw_queue_num_t queue_num, l2sw_qos_pri2queue_t *pPri2qid);
 ...
 */
extern l2sw_api_ret_t l2sw_qos_schedulingQueue_set(l2sw_uint8 units, l2sw_port_t port, l2sw_qos_queue_weights_t *pQweights);
 ...
 */
extern l2sw_api_ret_t l2sw_qos_schedulingQueue_get(l2sw_uint8 units, l2sw_port_t port, l2sw_qos_queue_weights_t *pQweights);
 ...
 *      - ENABLED
 */
extern l2sw_api_ret_t l2sw_qos_1pRemarkEnable_set(l2sw_uint8 units, l2sw_port_t port, l2sw_enable_t enable);
 ...
 *      - ENABLED
 */
extern l2sw_api_ret_t l2sw_qos_1pRemarkEnable_get(l2sw_uint8 units, l2sw_port_t port, l2sw_enable_t *pEnable);
 ...
 */
extern l2sw_api_ret_t l2sw_qos_1pRemark_set(l2sw_uint8 units, l2sw_pri_t int_pri, l2sw_pri_t dot1p_pri);
 ...
 */
extern l2sw_api_ret_t l2sw_qos_1pRemark_get(l2sw_uint8 units, l2sw_pri_t int_pri, l2sw_pri_t *pDot1p_pri);
 ...
 *      - ENABLED
 */
extern l2sw_api_ret_t l2sw_qos_dscpRemarkEnable_set(l2sw_uint8 units, l2sw_port_t port, l2sw_enable_t enable);
 ...
 *      - ENABLED
 */
extern l2sw_api_ret_t l2sw_qos_dscpRemarkEnable_get(l2sw_uint8 units, l2sw_port_t port, l2sw_enable_t *pEnable);
 ...
 */
extern l2sw_api_ret_t l2sw_qos_dscpRemark_set(l2sw_uint8 units, l2sw_pri_t int_pri, l2sw_dscp_t dscp);
 ...
 */
extern l2sw_api_ret_t l2sw_qos_dscpRemark_get(l2sw_uint8 units, l2sw_pri_t int_pri, l2sw_dscp_t *pDscp);
 ...
 *      priority to TX DSCP value.
 */
extern l2sw_api_ret_t l2sw_qos_dscpRemarkSrcSel_set(l2sw_uint8 units, l2sw_qos_dscpRmkSrc_t type);
 ...
 *      None
 */
extern l2sw_api_ret_t l2sw_qos_dscpRemarkSrcSel_get(l2sw_uint8 units, l2sw_qos_dscpRmkSrc_t *pType);
 ...
 */
extern l2sw_api_ret_t l2sw_qos_dscpRemark2Dscp_set(l2sw_uint8 units, l2sw_dscp_t dscp, l2sw_dscp_t rmkDscp);
 ...
 *      None.
 */
extern l2sw_api_ret_t l2sw_qos_dscpRemark2Dscp_get(l2sw_uint8 units, l2sw_dscp_t dscp, l2sw_dscp_t *pDscp);
 ...
 *      The API can set priority of port assignments for queue usage and packet scheduling.
 */
extern l2sw_api_ret_t l2sw_qos_portPriSelIndex_set(l2sw_uint8 units, l2sw_port_t port, l2sw_qos_priDecTbl_t index);
 ...
 *      The API can get priority of port assignments for queue usage and packet scheduling.
 */
extern l2sw_api_ret_t l2sw_qos_portPriSelIndex_get(l2sw_uint8 units, l2sw_port_t port, l2sw_qos_priDecTbl_t *pIndex);

#endif /* __L2SW_API_QOS_H__ */
