...
#ifndef __L2SW_API_LEAKY_H__
#define __L2SW_API_LEAKY_H__


typedef enum l2sw_leaky_type_e
{
    LEAKY_BRG_GROUP = 0,
    LEAKY_FD_PAUSE,
    LEAKY_SP_MCAST,
 ...
 *      - LEAKY_LLDP.
 */
extern l2sw_api_ret_t l2sw_leaky_vlan_set(l2sw_uint8 units, l2sw_leaky_type_t type, l2sw_enable_t enable);
 ...
 *      - LEAKY_LLDP.
 */
extern l2sw_api_ret_t l2sw_leaky_vlan_get(l2sw_uint8 units, l2sw_leaky_type_t type, l2sw_enable_t *pEnable);
 ...
 *      - LEAKY_LLDP.
 */
extern l2sw_api_ret_t l2sw_leaky_portIsolation_set(l2sw_uint8 units, l2sw_leaky_type_t type, l2sw_enable_t enable);
 ...
 *      - LEAKY_LLDP.
 */
extern l2sw_api_ret_t l2sw_leaky_portIsolation_get(l2sw_uint8 units, l2sw_leaky_type_t type, l2sw_enable_t *pEnable);

#endif /* __L2SW_API_LEAKY_H__ */
