...
define Profile/SF19A28-WS-IN
 NAME:= SF19A28 WS IN
 PACKAGES:=\
	block-mount fstools badblocks
endef

define Profile/SF19A28-WS-IN/Description
 Support for siflower WS IN boards v1.0
endef

define Profile/SF19A28-WS-IN/Config
...
$(eval $(call Profile,SF19A28-WS-IN))
