...
#
define Profile/SF19A28-ROUTER-1211
 NAME:= SF19A28 ROUTER-1211
 PACKAGES:=\
	block-mount fstools badblocks
endef
define Profile/SF19A28-ROUTER-1211/Description
 Support for siflower ac28 8+64 boards v1.0
endef
define Profile/SF19A28-ROUTER-1211/Config
...
endef
$(eval $(call Profile,SF19A28-ROUTER-1211))